...
namespace DashboarJira.Controller
{
    public class RANOController
    {
        ...
        public RANOController(JiraAccess jira)
        {
            jiraAccess = jira;
        }
        public RANOEntity RANOContratista(string start, string end)
        {
        ...
        public RANOEntity RANONoContratista(string start, string end)
        {
