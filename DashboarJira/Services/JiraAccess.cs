...
namespace DashboarJira.Services
{
    public class JiraAccess
    {
        ...
        public IssueJira convertIssueInIssueJira(Issue issue)
        {
            ...
            temp.TiempoResolucionAnio = issue.CustomFields["Tiempo a resolucion ANIO"] != null ? issue.CustomFields["Tiempo a resolucion ANIO"].ToString() : null;
            temp.TiempoResolucionAIO = issue.CustomFields["Tiempo a resolución AIO"] != null ? issue.CustomFields["Tiempo a resolución AIO"].ToString() : null;
